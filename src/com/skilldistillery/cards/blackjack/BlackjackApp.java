	...
	public void hitOrStay() {
		...
		while (!c.equals("S")) {
			...
			if (c.equals("H")) {
				...
				System.out.println("Player got 21! Pay up, Dealer!");
				System.exit(1);
			}if (player.handvalue() >= 22) {
				System.out.println(" Bust! Dealer wins ");
				System.out.println(" Final Player value:  " + player.handvalue());
				System.out.println(" Dealer final value:  " + dealer.calculateTotal());
				System.exit(1);
			}
